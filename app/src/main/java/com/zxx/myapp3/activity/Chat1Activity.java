...
public class Chat1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!EMClient.getInstance().isLoggedInBefore()) {
            Intent intent = new Intent(Chat1Activity.this, Fragment4.class);
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(chatId)) {
                    ...
                    if (chatId.equals(currUsername)) {
                        Toast.makeText(Chat1Activity.this, "不能和自己聊天", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    // 跳转到聊天界面，开始聊天
                    ...
                    Toast.makeText(Chat1Activity.this, "Username 不能为空", Toast.LENGTH_LONG).show();
                }
            }
        });
